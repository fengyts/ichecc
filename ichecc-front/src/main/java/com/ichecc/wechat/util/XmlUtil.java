...
public class XmlUtil {
	 ...
	 * @return
	 */
	public static String mapToXmlStr(SortedMap<String, Object> parameters) {
	 ...
	 * @throws Exception
	 */
	public static String beanToXmlStr(Object paramBean) throws Exception {
		try {
			SortedMap<String, Object> parameters = RequestUtil.sortBeanField(paramBean);
			String xmlStr = mapToXmlStr(parameters);
			return xmlStr;
		} catch (Exception e) {
			throw e;
		}
