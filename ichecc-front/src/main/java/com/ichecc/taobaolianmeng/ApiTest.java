package com.ichecc.taobaolianmeng;
...
public class ApiTest {
	...
	private static final String appKey = "25672410"; // 可替换为您的沙箱环境应用的appKey
	private static final String appSecret = "674638a45f5f7cb4d7b68ebae724abea"; // 可替换为您的沙箱环境应用的appSecret
