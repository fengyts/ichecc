...
<form class="form-horizontal dr-form-bordered" role="form" id="sysRoleAddForm">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control self_input" id="roleName" name="roleName" placeholder="请输入角色名称">
		</div>
	</div>
	<div class="form-group">
		<label for="lastname" class="col-sm-2 control-label">编码(如果不填则默认为角色名称拼音)</label>
		<div class="col-sm-10">
			<input type="text" class="form-control self_input" id="roleCode" name="roleCode" placeholder="请输入编码">
		</div>
	</div>
	<div class="form-group">
