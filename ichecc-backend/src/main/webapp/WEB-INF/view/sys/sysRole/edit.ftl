...
<@backend title="角色编辑" 
js=[
'/statics/plugins/zTree_v3/js/jquery.ztree.all.min.js',
'/statics/backend/sys/sysRole.js'
] 
css=[
'/statics/plugins/bootstrap/bootstrap-3.3.7-dist/css/bootstrap.min.css',
'/statics/plugins/zTree_v3/css/zTreeStyle/zTreeStyle.css'
]>
...
<form class="form-horizontal dr-form-bordered" role="form" id="sysRoleEditForm">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control self_input" id="roleName" name="roleName" value="${sysRole.roleName}"/>
		</div>
	</div>
	<div class="form-group">
		<label for="lastname" class="col-sm-2 control-label">编码(如果不填则默认为角色名称拼音)</label>
		<div class="col-sm-10">
			<input type="text" class="form-control self_input" id="roleCode" name="roleCode" value="${sysRole.roleCode}"/>
		</div>
	</div>
	<div class="form-group">
