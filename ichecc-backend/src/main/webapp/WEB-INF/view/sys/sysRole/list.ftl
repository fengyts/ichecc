	   ...
	   <div>	      
	       <table class="form_table" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td>角色名称:</td>
                  <td>
                  	<input type="text" name="roleName" class="input-text lh25" size="20" value='${sysRoleDO.roleName}'>
                  </td>                 
                  <td>状态:</td>
	              <td>
	                 <span class="fl">
            	...
            	<#if page.list?default([])?size!=0>
		            <#list page.getList() as sysRole>
		                <tr class="tr">
				              ...
				              <td class="td_center">${sysRole.roleName}</td>
		 					  <td class="td_center">${sysRole.roleCode}</td>
