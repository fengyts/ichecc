...
<form id="topicAddForm" action="" class="form-horizontal dr-form-bordered" method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<div class="col-md-4">
			<input type="text" class="form-control" disabled placeholder="系统自动生成">
		</div>
	...
	<div class="form-group">
		...
		<div class="col-md-4">
			<textarea class="form-control" rows="2" id="description" name="description" value="${topicDO.description}">${topicDO.description}</textarea>
		</div>
	</div>
	<div class="form-group">
